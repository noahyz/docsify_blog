import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as e,a,o as i}from"./app-BgxYdExa.js";const l={};function p(t,s){return i(),e("div",null,s[0]||(s[0]=[a(`<h2 id="评估系统的网络性能" tabindex="-1"><a class="header-anchor" href="#评估系统的网络性能"><span>评估系统的网络性能</span></a></h2><p>对于各协议层的性能进行测试</p><h3 id="一、转发性能" tabindex="-1"><a class="header-anchor" href="#一、转发性能"><span>一、转发性能</span></a></h3><p>网络接口层和网络层，他们主要负责网络包的封装、寻址、路由以及发送和接收。在这两个网络协议层中，每秒可处理的网络包数 PPS，就是最重要的性能指标。特别是 64B 小包的处理能力。</p><p>测试网络包的处理能力，使用 pktgen 。详情：<a href="https://time.geekbang.org/column/article/81497" target="_blank" rel="noopener noreferrer">https://time.geekbang.org/column/article/81497</a></p><h3 id="二、tcp-udp-性能" tabindex="-1"><a class="header-anchor" href="#二、tcp-udp-性能"><span>二、TCP/UDP 性能</span></a></h3><p>使用 iperf 。详情：<a href="https://time.geekbang.org/column/article/81497" target="_blank" rel="noopener noreferrer">https://time.geekbang.org/column/article/81497</a></p><h3 id="三、http性能" tabindex="-1"><a class="header-anchor" href="#三、http性能"><span>三、HTTP性能</span></a></h3><p>ab 是 Apache 自带的 HTTP 压测工具，主要测试 HTTP 服务的每秒请求数、请求延迟、吞吐量以及请求延迟的分布情况等</p><p>安装 ab 工具：<code>yum install -y httpd-tools</code></p><p>比如在一台机器上部署一个 nginx 服务，然后在另一台机器上用 ab 来测试他的性能</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#24292e;--shiki-dark:#abb2bf;--shiki-light-bg:#fff;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes github-light one-dark-pro vp-code"><code><span class="line"><span>[root@VM_14_255_centos ~]# ab -c 1000 -n 10000 http://9.134.239.95:1100/</span></span>
